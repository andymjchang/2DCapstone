...
@export var vinyl_rotations: Array[float] = [0.0, -30.0, -60.0, -90.0]  # Adjust these values as needed
...
func update_selection() -> void:
    ...
    tween.set_ease(Tween.EASE_OUT)
    tween.set_trans(Tween.TRANS_CUBIC)
    tween.tween_property($LevelSelectVinyl, "rotation_degrees", 
    ...
    match current_option:
        LevelOptions.LEVEL_1:
            vinyl.rotation_degrees = vinyl_rotations[0]
        LevelOptions.LEVEL_2:
            vinyl.rotation_degrees = vinyl_rotations[1]
        LevelOptions.LEVEL_3:
            vinyl.rotation_degrees = vinyl_rotations[2]
        LevelOptions.BACK:
